      ...
      <div className="order-last flex gap-2 overflow-x-auto lg:order-first lg:flex-col">
        {productImages?.map((image, index) => (
          <button
            ...
            className={cn(
              'bg-muted hover:bg-muted/80 focus-visible:ring-primary relative aspect-square size-20 w-full shrink-0 cursor-pointer overflow-hidden rounded-md border transition-colors focus-visible:ring-2 focus-visible:outline-none',
              activeImage === image
