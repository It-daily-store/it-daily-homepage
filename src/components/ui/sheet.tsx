...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'bg-pure-black/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50',
      className,
    )}
    {...props}
    ref={ref}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps & { withCloseButton?: boolean }
>(
  (
    { side = 'right', className, withCloseButton = true, children, ...props },
    ref,
  ) => (
    <SheetPortal>
      <SheetOverlay />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn('text-dark-gray text-lg font-semibold', className)}
    {...props}
  />
));
